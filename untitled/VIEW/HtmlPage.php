...
abstract class HtmlPage
{
        ...
        echo '<!doctype html>
             ...
             <form action="/SearchBar" method="post">
                <ul>
                   ...
                   <li>
                   <input class="input_menu" placeholder="Rechercher une recette" name="rechercher"/>
                        <input class="input_menu2" type="submit" name="action" value="Valider"/>
                   </li>';
    ...
    public function topRecette() {
        echo '<h2>Meilleure recette du moment !!</h2>';
    }
    ...
    public function connecter() {
        ...
        echo '<section class="sec_log">
            <div class="inter_div">
              <h1 class="titre_h1">Voulez-vous vraiment vous déconnecter ?</h1>
              <p>Redirection vers  : <a href="/Compte">Mon compte</a></p>
    ...
    public function ShowTheRecetteVisitor($recette){
        echo'
                    ...
                    <label> Titre de la recette : </label> <input style="width: 300px; text-align: center; font-size: 13px;" type="text" name="titre" disabled="true" class="editable" form="editerRecette" value="'.$recette['NAME'].'"/> <br>
    ...
    public function LikeBurn($idR) {
        echo '<a class="like-unlike" href="/DescriptionRecette/gestionBurn/add/'. $idR . '">Burn</a>';
    }

    public function DelBurn($idR) {
        echo '<a class="like-unlike" href="/DescriptionRecette/gestionBurn/del/'. $idR . '">UnBurn</a><br>';
    }
